...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        taxiPark.addVehicle(lamborghiniVeneno);
        taxiPark.addVehicle(mclarenSenna);
        taxiPark.addVehicle(audiA7);
        taxiPark.addVehicle(teslaModelX);
        taxiPark.addVehicle(mercedesAMG);
        taxiPark.addVehicle(mulsanne);
        taxiPark.addVehicle(hummerH2);
        taxiPark.addVehicle(cadillacEscalade);


        System.out.println("Unsorted cars: \n" + taxiPark.toString());
        taxiPark.sortByFuelUsing();
