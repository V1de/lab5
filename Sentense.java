...
class Sentense {
    private ArrayList<SentenceComponent> wordList;

    public Sentense(String someLine) {
        wordList = splitToWords(someLine);
    }

    private ArrayList<SentenceComponent> splitToWords(String someLine) {
        String[] splitLine = someLine.split(" ");
        ArrayList<SentenceComponent> resultWordList = new ArrayList<>();
        String tempWord;
        String lastLetter;
        String filteredWord;
    ...
    public void filterSentenses(){
        for(SentenceComponent word: wordList){
